...
The environment (`.cursor/environment.json`) installs dependencies in `install` and
starts the dashboard in the `streamlit` terminal on port 8501. To run it manually from
the repo root:
